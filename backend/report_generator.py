            ...
            if not evidence_files:
                ...
                <div class="evidence-gallery-section">
                    ...
                    <div class="no-evidence-message">
                        ...
                        <h4>No Evidence Files Found</h4>
                        <p>No violation evidence found in <code>D:\\embed\\SMOKI\\esp32\\evidence</code></p>
                        <p>Run <strong>laptop_snap.py</strong> to detect violations and generate evidence files.</p>
                        <div class="evidence-help">
                            <h5>Expected Files:</h5>
                            <ul>
                                <li><code>violation_evidence_PLATE_TIMESTAMP.jpg</code> - Evidence images</li>
                                <li><code>violation_evidence_PLATE_TIMESTAMP.json</code> - Metadata files</li>
                            </ul>
                        </div>
                    </div>
                </div>
